...
export default function Modal({ visible }) {
  ...
  const modalClass = visible ? "modal" : "modal hidden";
    ...
    const handleSubmit = async (e) => {
        ...
        const subject = "";
        try {
          const response = await fetch('https://portfolio-mail-server.onrender.com/sendmail', {
            method: 'POST',
            headers: {
  ...
  return (
    <form className={modalClass} onSubmit={handleSubmit}>
      ...
      <div className="ipt">
        ...
        <textarea name="" id="message" cols="70" rows="14" required onChange={handleMessageChange}></textarea>
      </div>
